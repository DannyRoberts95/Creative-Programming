...
function setup() {
  ...
  grid = new Grid(moduleSize, padding, colNum, rowNum, canvasPadding, 1.5, 10, 100);
...
function draw() {
  ...
  stroke(95);
  strokeWeight(2);
  rect(canvasPadding / 2, canvasPadding / 2, width - canvasPadding, height - canvasPadding);
