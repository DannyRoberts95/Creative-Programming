...
let canvasPadding = (moduleSize + padding) * 10;
...
function setup() {
  ...
  grid = new Grid(moduleSize, padding, colNum, rowNum, canvasPadding, 1, 10, 100);
...
function draw() {
  ...
  stroke(95);
  strokeWeight(1);
  rect(canvasPadding*.75, canvasPadding*.75, width - canvasPadding*1.5, height - canvasPadding*1.5);
